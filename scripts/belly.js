...
function Belly(robotId, scale, resizeAxis, username) {
  ...
  Belly.backButtonClicked = function (screenID) {
    if (
      ...
      Belly.bellyScreens[
        screenID
      ].navButtonList.backButton.lastPressed = date.getTime();
      var dir = 'study_users/' + username + '/robots/' + Belly.robotId + '/customAPI/inputs/';
